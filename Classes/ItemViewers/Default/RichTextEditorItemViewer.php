...
/**
 * Default Rich text editor item Viewer.
 * 
 * @package SavLibraryPlus
 * @version $ID:$
 */
 
class Tx_SavLibraryPlus_ItemViewers_Default_RichTextEditorItemViewer extends Tx_SavLibraryPlus_ItemViewers_Default_AbstractItemViewer {
